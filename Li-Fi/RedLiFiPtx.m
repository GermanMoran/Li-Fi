function varargout = RedLiFiPtx(varargin)
%REDLIFIPTX MATLAB code file for RedLiFiPtx.fig
%      REDLIFIPTX, by itself, creates a new REDLIFIPTX or raises the existing
%      singleton*.
%
%      H = REDLIFIPTX returns the handle to a new REDLIFIPTX or the handle to
%      the existing singleton*.
%
%      REDLIFIPTX('Property','Value',...) creates a new REDLIFIPTX using the
%      given property value pairs. Unrecognized properties are passed via
%      varargin to RedLiFiPtx_OpeningFcn.  This calling syntax produces a
%      warning when there is an existing singleton*.
%
%      REDLIFIPTX('CALLBACK') and REDLIFIPTX('CALLBACK',hObject,...) call the
%      local function named CALLBACK in REDLIFIPTX.M with the given input
%      arguments.
%
...
% Edit the above text to modify the response to help RedLiFiPtx

% Last Modified by GUIDE v2.5 04-Feb-2020 00:24:22

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @RedLiFiPtx_OpeningFcn, ...
                   'gui_OutputFcn',  @RedLiFiPtx_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
% --- Executes just before RedLiFiPtx is made visible.
function RedLiFiPtx_OpeningFcn(hObject, eventdata, handles, varargin)
...
% Choose default command line output for RedLiFiPtx
...
function varargout = RedLiFiPtx_OutputFcn(hObject, eventdata, handles)
...
ParametrosRedTx=zeros(1,8);
ParametrosRedTx(1,1)=str2double(get(handles.xtx1, 'String'));
ParametrosRedTx(1,2)=str2double(get(handles.ytx1, 'String'));
ParametrosRedTx(1,3)=str2double(get(handles.xtx2, 'String'));
ParametrosRedTx(1,4)=str2double(get(handles.ytx2, 'String'));
ParametrosRedTx(1,5)=str2double(get(handles.xtx3, 'String'));
ParametrosRedTx(1,6)=str2double(get(handles.ytx3, 'String'));
ParametrosRedTx(1,7)=str2double(get(handles.xtx4, 'String'));
ParametrosRedTx(1,8)=str2double(get(handles.ytx4, 'String'));

 if isnan(ParametrosRed(1,1)) || isnan(ParametrosRed(1,2)) || isnan(ParametrosRed(1,3)) || isnan(ParametrosRed(1,4)) || isnan(ParametrosRed(1,5)) || isnan(ParametrosRed(1,6)) || isnan(ParametrosRed(1,7)) || isnan(ParametrosRed(1,8)) || isnan(ParametrosRedTx(1,1)) || isnan(ParametrosRedTx(1,2)) || isnan(ParametrosRedTx(1,3)) || isnan(ParametrosRedTx(1,4)) || isnan(ParametrosRedTx(1,5)) || isnan(ParametrosRedTx(1,6))|| isnan(ParametrosRedTx(1,7)) || isnan(ParametrosRedTx(1,8))
    ...
    save ParametrosRedTx.mat ParametrosRedTx
 end
...
% --- Executes on button press in redlifiptx.
function pushbutton6_Callback(hObject, eventdata, handles)
% hObject    handle to redlifiptx (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
set(handles.xtx1, 'String','2.5');
set(handles.ytx1, 'String','2.2');
set(handles.xtx2, 'String','2.5');
set(handles.ytx2, 'String','10.01');
set(handles.xtx3, 'String','10.46');
set(handles.ytx3, 'String','2.2');
set(handles.xtx4, 'String','10.46');
set(handles.ytx4, 'String','10.1');
...
set(handles.cr3, 'String','');
set(handles.cr4, 'String','');
set(handles.xtx1, 'String','');
set(handles.ytx1, 'String','');
set(handles.xtx2, 'String','');
set(handles.ytx2, 'String','');
set(handles.xtx3, 'String','');
set(handles.ytx3, 'String','');
set(handles.xtx4, 'String','');
set(handles.ytx4, 'String','');
...
tx1=ParametrosRedTx.ParametrosRedTx(1,1);
ty1=ParametrosRedTx.ParametrosRedTx(1,2);
tx2=ParametrosRedTx.ParametrosRedTx(1,3);
ty2=ParametrosRedTx.ParametrosRedTx(1,4);
tx3=ParametrosRedTx.ParametrosRedTx(1,5);
ty3=ParametrosRedTx.ParametrosRedTx(1,6);
tx4=ParametrosRedTx.ParametrosRedTx(1,7);
ty4=ParametrosRedTx.ParametrosRedTx(1,8);



[ptx1,pty1,ptx2,pty2,ptx3,pty3,ptx4,pty4]=CuadriculaTx(tx1,ty1,tx2,ty2,tx3,ty3,tx4,ty4);
...
set(handles.axes2,'GridColor','k')
box on
axis([0 ParametrosRed.ParametrosRed(1,2) 0 ParametrosRed.ParametrosRed(1,1)])
axis square
...
% --- Executes on button press in CoberturaRed.
function CoberturaRed_Callback(hObject, eventdata, handles)
% hObject    handle to CoberturaRed (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
global boton1
boton1 = get(handles.CoberturaRed,'value');
if boton1==1
    RedLiFi;
    close(RedLiFiPtx);
...
function xtx1_Callback(hObject, eventdata, handles)
% hObject    handle to xtx1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of xtx1 as text
%        str2double(get(hObject,'String')) returns contents of xtx1 as a double


% --- Executes during object creation, after setting all properties.
function xtx1_CreateFcn(hObject, eventdata, handles)
% hObject    handle to xtx1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function ytx1_Callback(hObject, eventdata, handles)
% hObject    handle to ytx1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of ytx1 as text
%        str2double(get(hObject,'String')) returns contents of ytx1 as a double


% --- Executes during object creation, after setting all properties.
function ytx1_CreateFcn(hObject, eventdata, handles)
% hObject    handle to ytx1 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function xtx2_Callback(hObject, eventdata, handles)
% hObject    handle to xtx2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of xtx2 as text
%        str2double(get(hObject,'String')) returns contents of xtx2 as a double


% --- Executes during object creation, after setting all properties.
function xtx2_CreateFcn(hObject, eventdata, handles)
% hObject    handle to xtx2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function ytx2_Callback(hObject, eventdata, handles)
% hObject    handle to ytx2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of ytx2 as text
%        str2double(get(hObject,'String')) returns contents of ytx2 as a double


% --- Executes during object creation, after setting all properties.
function ytx2_CreateFcn(hObject, eventdata, handles)
% hObject    handle to ytx2 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function xtx3_Callback(hObject, eventdata, handles)
% hObject    handle to xtx3 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of xtx3 as text
%        str2double(get(hObject,'String')) returns contents of xtx3 as a double


% --- Executes during object creation, after setting all properties.
function xtx3_CreateFcn(hObject, eventdata, handles)
% hObject    handle to xtx3 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function ytx3_Callback(hObject, eventdata, handles)
% hObject    handle to ytx3 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of ytx3 as text
%        str2double(get(hObject,'String')) returns contents of ytx3 as a double


% --- Executes during object creation, after setting all properties.
function ytx3_CreateFcn(hObject, eventdata, handles)
% hObject    handle to ytx3 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function xtx4_Callback(hObject, eventdata, handles)
% hObject    handle to xtx4 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of xtx4 as text
%        str2double(get(hObject,'String')) returns contents of xtx4 as a double


% --- Executes during object creation, after setting all properties.
function xtx4_CreateFcn(hObject, eventdata, handles)
% hObject    handle to xtx4 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function ytx4_Callback(hObject, eventdata, handles)
% hObject    handle to ytx4 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of ytx4 as text
%        str2double(get(hObject,'String')) returns contents of ytx4 as a double


% --- Executes during object creation, after setting all properties.
function ytx4_CreateFcn(hObject, eventdata, handles)
% hObject    handle to ytx4 (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
