    ...
    tic
    % Numero de subportadoras segun OFDM
    N_sub=64;
    % Numero de portadoras de informacion
    N_inf=64;
    % Número de portadora de CP
    num_cp=round(N_sub);
...
% % 
    ...
    Rate=16*N_sub;   % Factor de sobre muestreo-> numero de muestras por cada pulso 
